        ...
        try:
            ...
            if conn:
                ...
                for articulo in listArticulos:
                    print(articulo[0])
                    query = text(
                        f"SELECT top(1) IDArticulo FROM tbMaestroArticulo WHERE IDArticulo = N'{articulo[0]}' "
                    )
            ...
            result.append(
                {
                    ...
                    "IDEstado": 0,
                    "IDTipo": (
                        str(linea[10]).zfill(2)
                        if linea[10] is not None and linea[10] != "0"
                        else "04"
                    ),
                    "IDFamilia": "VENTACLIEN" if linea[10] == 1 else linea[2],
                    "IDSubfamilia": (
                        linea[2]
                        if not None and linea[10] == 1
                        else linea[3] if linea[3] is not None else "00"
                    ),
    ...
    def export_to_excel_art_desd_indus(data):
        ...
        df = pd.DataFrame(
            ...
            columns=[
                ...
                "CriterioValoracion",
                "GestionStockPorLotes",
                "PrecioUltimaCompraA",
                "PrecioUltimaCompraB",
                "FechaUltimaCompra",
                "IDProveedorUltimaCompra",
                "LoteMultiplo",
                "CantMinSolicitud",
                "CantMaxSolicitud",
                "LimitarPetDia",
                "IdArticuloConfigurado",
                "ContRadical",
                "IdFamiliaConfiguracion",
                "PrecioBase",
                "Configurable",
                "FechaCreacionAudi",
                ...
                "NSerieObligatorio",
                "PuntosMarketing",
                "ValorPuntosMarketing",
                "ValorReposicionA",
                "ValorReposicionB",
                "FechaValorReposicion",
                "ControlRecepcion",
                "IDEstadoHomologacion",
                "IDArticuloFinal",
                "GenerarOFArticuloFinal",
                "IdDocumentoEspecificacion",
                "NivelModificacionPlan",
                "FechaModificacionNivelPlan",
                "TipoFactAlquiler",
                "Seguridad",
                "Reglamentacion",
                "SeguridadReglamentacion",
                "DiasMinimosFactAlquiler",
                "SinDtoEnAlquiler",
                "SinSeguroEnAlquiler",
                "NecesitaOperario",
                "IDConcepto",
                ...
                "QEmbalaje",
                "Color",
                "IDCaracteristicaArticulo1",
                "IDCaracteristicaArticulo2",
                "IDCaracteristicaArticulo3",
                "IDCaracteristicaArticulo4",
                "IDCaracteristicaArticulo5",
                "IDArticuloPadre",
                "TipoPrecio",
                "IDTipoProducto",
                "IDTipoMaterial",
                ...
                "IDUdInterna2",
                "Observaciones",
                "PorcenIVANoDeducible",
                "PrecioBaseConfigurado",
                "Alias",
                "IDCategoria",
                "IDAnada",
                "IDColorVino",
                ...
                "IncluirEnEMCS",
                "ClaveDeclaracion",
                "IDRegistroFitosanitario",
                "RiquezaNPK",
                "IDTipoAbono",
                "IDTipoFertilizacion",
                "ClaveProductoSilicie",
                "TipoEnvaseSilicie",
                "ExcluirSilicie",
                "IDCalificacion",
                "IDProductoVino",
                ...
                "TIPO15085",
                "ExcluirCupos",
                "IDCampanaCupoClasificacion",
                "KGPlastico",
                "KGPlasticoNR",
                "ClaveProducto",
                "GestionContraPedidoVenta",
                "UsuarioCreacionAudi",
                "Espesor",
                "Activo",
                "Venta",
...
input("Continuar")
checkSubFamiliaSolmicro = obj.CheckArticuloSolmicro(
    listArticulos=listSubfamiliaIndustry
)
